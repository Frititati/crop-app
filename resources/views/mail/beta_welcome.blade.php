                           ...
                           <table role="presentation" style="border-collapse: separate; width: 100%;">
                              <tr>
                                 <td style="font-family: 'Poppins', sans-serif; font-size: 14px;">
                                    ...
                                    <p style="font-family: 'Poppins', sans-serif; font-size: 14px; font-weight: normal; margin: 0 0 15px;">Non appena farai il login, sarai reindirizzato in una pagina in cui ti verranno mostrate le funzioni dell'applicazione.</p>
